...
public class TransactionController {
    ...
    public ResponseEntity<List<TransactionDTO>> getTransactions(@RequestHeader(name = "my-token", required = false) String token) {
        if (token != null) {
     ...
     *
     * @param token         token "my-token" should be passed in this variable
    ...
    public ResponseEntity<TransactionDTO> getTransaction(@RequestHeader(name = "my-token", required = false) String token,
    ...
    public ResponseEntity<List<TransactionDTO>> getTransactionList(@RequestHeader(name = "my-token", required = false) String token,
